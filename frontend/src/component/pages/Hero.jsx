        ...
        <>
            <div className="lg:h-[90vh] lg:w-full md:h-full md:w-full bg-pureblack">
                <div className="lg:h-[90vh] lg:w-[95%] lg:mx-auto lg:flex lg:justify-center lg:items-center md:h-[90vh] md:w-full md:flex md:justify-center md:items-center sm:h-[180vh] sm:w-full">
                    <div className="lg:h-full lg:w-[60%] md:h-[90vh] md:w-[60%] sm:h-[90vh] sm:w-full">
                        <div className='lg:h-full lg:w-full md:h-full md:w-full sm:h-full sm:w-full'>
                            ...
                            <div className="lg:h-[30vh] lg:w-full lg:flex lg:justify-center text-gray1 font-normal md:h-[30vh] md:w-full md:flex md:justify-center sm:h-[30vh] sm:w-full sm:flex sm:justify-center h-[30vh] w-full flex justify-center">
                                <div className="lg:h-full lg:w-[30%] text-5xl lg:flex lg:items-center lg:justify-center border-r border-gray-800 md:h-full md:w-[30%] md:flex md:items-center md:justify-center sm:h-full sm:w-[30%] sm:flex sm:items-center sm:justify-center">
                                    <div>
                                        <p className="text-white">300<span className="text-amber-400">+</span></p>
                                        <p className="text-base">Resources available</p>
                                    </div>
                                </div>
                                <div className="lg:h-full lg:w-[30%] text-5xl lg:flex lg:items-center lg:justify-center border-r border-gray-800 md:h-full md:w-[30%] md:flex md:items-center md:justify-center sm:h-full sm:w-[30%] sm:flex sm:items-center sm:justify-center">
                                    <div>
                                ...
                                <div className="lg:h-full lg:w-[40%] text-5xl lg:flex lg:items-center lg:justify-center border-r border-gray-800 md:h-full md:w-[40%] md:flex md:items-center md:justify-center sm:h-full sm:w-[40%] sm:flex sm:items-center sm:justify-center">
                                    <div>
                    ...
                    <div className="lg:h-full lg:w-[40%] md:h-[90vh] md:w-[40%] sm:h-[90vh] sm:w-full">
