...
export default function Home() {
  ...
  const seoTitle = "Neuradhoor | AI Blog Platform";
  const seoDescription =
    "Explore Neuradhoor, an AI blog platform featuring cutting-edge insights, expert analysis, research updates, and future-focused content.";
  const seoImage = `${siteUrl}/og-home.png`;
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Neuradhoor, AI blog, artificial intelligence, machine learning, future tech, research insights"
        />
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-black mb-8 dark:bg-gradient-to-r from-white via-orange-300 to-yellow-400 bg-gradient-to-r from-slate-900 via-blue-400 to-indigo-500 bg-clip-text dark:text-transparent text-transparent leading-tight">
                ...
                <span className="block text-5xl md:text-6xl dark:text-white/90 text-slate-900/90 font-normal mt-4">
                  Platform
                </span>
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                >
                  {/* Gradient Orb */}
                  <div
                    className={`absolute top-6 right-6 w-24 h-24 bg-gradient-to-r ${stat.color} opacity-20 rounded-2xl blur-xl group-hover:opacity-40 transition-all`}
                  ></div>

                  <div className="relative z-10">
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${stat.color} rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform`}
                    >
                ...
                {[
                  {
                    ...
                    color: "dark:from-blue-400 from-emerald-400 dark:to-blue-500 to-emerald-500",
                  },
                  {
                    id: "live",
                    title: "Live",
                    desc: "Real-time updates",
                    color: "dark:from-green-400 from-green-500 dark:to-green-500 to-green-600",
                  },
                  {
                    id: "expert",
                    title: "Expert",
                  ...
                  },
                  {
                    ...
                    title: "Visual",
                    desc: "Rich graphics",
                    color: "dark:from-orange-400 from-orange-500 dark:to-orange-500 to-orange-600",
                  },
                ].map((feature) => (
                  <motion.div
                    key={feature.id}
                  ...
                  >
                    <div
                      className={`w-12 h-12 bg-gradient-to-r ${feature.color} rounded-xl flex items-center justify-center mb-4 shadow-lg group-hover:scale-110`}
                    >
                ...
                {[
                  {
                    ...
                    color: "dark:from-indigo-400 from-pink-400 dark:to-indigo-500 to-pink-500",
                  },
                  {
                    id: "data",
                    title: "Data",
                    desc: "Live datasets",
                    color: "dark:from-emerald-400 from-teal-400 dark:to-emerald-500 to-teal-500",
                  },
                  {
                    id: "trends",
                    title: "Trends",
                    desc: "Emerging patterns",
                    color: "dark:from-rose-400 from-rose-500 dark:to-rose-500 to-rose-600",
                  },
                  {
                    id: "visuals",
                    title: "Visuals",
                    desc: "Interactive charts",
                    color: "dark:from-sky-400 from-sky-500 dark:to-sky-500 to-sky-600",
                  },
                ].map((feature) => (
                  <motion.div
                    key={feature.id}
