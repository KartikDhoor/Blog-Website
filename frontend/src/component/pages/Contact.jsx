...
>
    ...
    <div className="space-y-3">
        ...
        >
            <span className="flex-1 font-semibold dark:text-gray-100 text-gray-900 truncate pr-2 break-all">contact@neuradhoor.com</span>
        ...
        <motion.button 
            ...
            className="w-full flex items-center justify-between gap-3 p-4 dark:bg-gradient-to-r dark:from-orange-500/10 dark:to-yellow-500/10 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border dark:border-orange-400/40 border-blue-400/40 rounded-xl hover:dark:bg-orange-500/20 hover:bg-blue-500/20 transition-all backdrop-blur-xl shadow-lg hover:shadow-xl text-sm"
        >
            <span className="flex-1 font-semibold dark:text-gray-100 text-gray-900 truncate pr-2">+91 99238 38448</span>
            <MdShare className="text-lg dark:text-orange-400 text-blue-500 flex-shrink-0" />
        </motion.button>
    </div>
</motion.div>
...
>
    ...
    <div className="space-y-3">
        <motion.button 
            ...
            className="w-full flex items-center justify-between gap-3 p-4 dark:bg-gradient-to-r dark:from-orange-500/10 dark:to-yellow-500/10 bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border dark:border-orange-400/40 border-blue-400/40 rounded-xl hover:dark:bg-orange-500/20 hover:bg-blue-500/20 transition-all backdrop-blur-xl shadow-lg hover:shadow-xl text-sm"
        >
            <span className="flex-1 font-semibold dark:text-gray-100 text-gray-900 truncate pr-2 break-all">support@neuradhoor.com</span>
            <MdShare className="text-lg dark:text-orange-400 text-blue-500 flex-shrink-0" />
        </motion.button>
        <motion.button 
            whileHover={{ scale: 1.02, x: 4 }}
            ...
            <MdShare className="text-lg dark:text-orange-400 text-blue-500 flex-shrink-0" />
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed font-semibold">
                                        231 AI Tech Avenue<br/>Techvilla, 647878
                                    </p>
                                    <motion.button 
                                        whileHover={{ scale: 1.02, x: 4 }}
                                        whileTap={{ scale: 0.98 }}
                                    ...
                                    >
                                        <span className="text-left flex-1 font-semibold dark:text-gray-100 text-gray-900">Get Directions</span>
                ...
                <div className="py-20">
                    <div className="w-[90%] max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="space-y-6 p-8 lg:p-12 dark:bg-gradient-to-br dark:from-gray-900/50 dark:to-gray-800/50 bg-gradient-to-br from-slate-100/50 to-white/50 backdrop-blur-xl rounded-3xl border dark:border-orange-500/30 border-blue-500/30 shadow-2xl">
                                ...
                                <motion.button 
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="w-full py-5 px-8 dark:bg-gradient-to-r from-orange-500 to-orange-600 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold text-xl rounded-3xl shadow-2xl dark:shadow-orange-500/25 shadow-blue-500/25 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                                >
                                    Send Message
                                </motion.button>
                            </div>
