        ...
        <div className="h-full w-full bg-pureblack">
            <div className="lg:h-[40vh] lg:w-full lg:border-y lg:border-gray-800
                ...
                <div className="lg:h-full lg:w-[90%] lg:mx-auto lg:flex lg:justify-center
                    ...
                    <div className="lg:h-full lg:w-[25%] lg:flex lg:items-center lg:justify-center lg:border-r lg:border-gray-800
                                    md:h-full md:w-[25%] md:flex md:items-center md:justify-center md:border-r md:border-gray-800
                                    sm:h-[30vh] sm:w-full sm:flex sm:items-center sm:justify-center sm:border-b sm:border-gray-800
                                    belowSm:h-[30vh] belowSm:w-full belowSm:flex belowSm:items-center belowSm:justify-center belowSm:border-b belowSm:border-gray-800">
                        <div className="">
                    ...
                    <div className="lg:h-full lg:w-[25%] lg:flex lg:items-center lg:justify-center lg:border-r lg:border-gray-800
                                    ...
                                    sm:h-[30vh] sm:w-full sm:flex sm:items-center sm:justify-center sm:border-b sm:border-gray-800
                                    belowSm:h-[30vh] belowSm:w-full belowSm:flex belowSm:items-center belowSm:justify-center belowSm:border-b belowSm:border-gray-800">
                        <div className="lg:w-[80%] md:w-[80%] sm:w-[50%] belowSm:w-[60%]">
            ...
            <div className="lg:h-[60vh] lg:w-full md:h-[60vh] md:w-full sm:h-full sm:w-full belowSm:h-full belowSm:w-full border-y border-gray-800">
                <div className="lg:h-full lg:w-[90%] lg:mx-auto lg:flex lg:justify-center
                    ...
                    <div className="lg:h-full lg:w-[40%] lg:border-r lg:border-gray-800 lg:flex lg:items-center
                                    ...
                                    belowSm:h-[50vh] belowSm:w-full belowSm:border-b belowSm:border-gray-800 belowSm:flex belowSm:items-center">
                        <div>
                        <GiBugleCall className="text-8xl text-amber-400"/>
                        <p className="text-5xl text-white font-medium">Get in touch With the Team</p>
                        </div>
                    </div>
                    <div className="lg:h-full lg:w-[60%] lg:flex lg:items-center lg:justify-center
                                    md:h-full md:w-[60%] md:flex md:items-center md:justify-center
                                    sm:h-[70vh] sm:w-full sm:flex sm:items-center sm:justify-center
                                    belowSm:h-[70vh] belowSm:w-full belowSm:flex belowSm:items-center belowSm:justify-center">
                        <div className="w-[95%]">
